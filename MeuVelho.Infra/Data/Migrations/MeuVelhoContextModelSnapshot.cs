...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeuVelho.Domains.CidadeDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeuVelho.Domains.ContatoDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeuVelho.Domains.CuidadorCidadeDomain", b =>
                {
            ...
            modelBuilder.Entity("MeuVelho.Domains.CuidadorDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeuVelho.Domains.EstadoDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeuVelho.Domains.PaisDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MeuVelho.Domains.CidadeDomain", b =>
                {
                    b.HasOne("MeuVelho.Domains.EstadoDomain", "Estado")
                        .WithMany("Cidades")
            ...
            modelBuilder.Entity("MeuVelho.Domains.ContatoDomain", b =>
                {
                    b.HasOne("MeuVelho.Domains.CuidadorDomain", "Cuidador")
                        .WithMany("Contatos")
            ...
            modelBuilder.Entity("MeuVelho.Domains.CuidadorCidadeDomain", b =>
                {
                    b.HasOne("MeuVelho.Domains.CidadeDomain", "Cidade")
            ...
            modelBuilder.Entity("MeuVelho.Domains.EstadoDomain", b =>
                {
                    b.HasOne("MeuVelho.Domains.PaisDomain", "Pais")
                        .WithMany("Estados")
